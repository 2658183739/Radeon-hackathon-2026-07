...
**Evidence and boundary.** Ten dispatch tests plus the cylinder unit tests pass
...
Zero offset and risk thresholds remain legal so registered ablations can
collapse candidate dimensions without source edits.
