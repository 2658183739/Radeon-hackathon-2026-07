...
| Cylindrical parcel handling | Analytic candidates and shape dispatch verified; physical screen pending | 128/128 outcome-free samples and 20 dispatch/cylinder tests pass; runtime activation is still forbidden and oversized tubes remain `cradle_required` |
