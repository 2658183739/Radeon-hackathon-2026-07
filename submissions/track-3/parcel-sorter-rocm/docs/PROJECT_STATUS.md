...
| Cylindrical parcel handling | Analytic candidates verified; physical screen pending | 128/128 outcome-free samples produce unique axis-aligned candidates; oversized tubes remain `cradle_required` |
