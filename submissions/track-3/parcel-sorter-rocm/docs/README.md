...
| Controller-faithful probe v4 | [Train-only feasibility protocol](CONTROLLER_FAITHFUL_PROBE_V4_PROTOCOL.md) | [Train-only 可行性协议](CONTROLLER_FAITHFUL_PROBE_V4_PROTOCOL_CN.md) |
| Controller-faithful probe v4 result | [Train-only safety result](CONTROLLER_FAITHFUL_PROBE_V4_TRAIN_RESULTS.md) | [Train-only 安全结果](CONTROLLER_FAITHFUL_PROBE_V4_TRAIN_RESULTS_CN.md) |
