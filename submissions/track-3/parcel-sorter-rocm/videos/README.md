...
10-episode deterministic expert/reference development screen: `0, 1, 2, 4,
...
视频只包含 10 回合确定性专家/参考开发筛选中的 8 个成功回合：`0、1、2、4、
6、7、8、9`。回合 0 和 7 同时展示同步全景与腕部视角，其余六个回合展示全景。
最终成片为 1920x1080 H.264、59.0 秒，并烧录中英双语字幕。仿真源视频为
224x224，不宣称为原生 1080p。

This is simulation reference evidence, not real-robot footage and not a
pure-VLA result. The strict pure-VLA campaign remains 0/3. A Bilibili/YouTube
...
这是仿真参考证据，不是真实机器人视频，也不是纯 VLA 成绩。严格纯 VLA 结果仍为
